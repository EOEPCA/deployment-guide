...
export APP_QUALITY_ENABLE_GITHUB_STATUS="${APP_QUALITY_ENABLE_GITHUB_STATUS:-false}"
add_to_state_file "APP_QUALITY_ENABLE_GITHUB_STATUS" "${APP_QUALITY_ENABLE_GITHUB_STATUS}"
