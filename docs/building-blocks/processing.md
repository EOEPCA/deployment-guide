...
-   :material-cog-outline:{ .lg .middle } **OGC API Processes Engine**

    ---

    Deploy, manage, and execute OGC Application Packages. Provided by the [ZOO-Project](https://zoo-project.github.io/docs/intro.html#what-is-zoo-project) `zoo-project-dru` implementation - supporting OGC WPS 1.0.0/2.0.0 and OGC API Processes Parts 1 & 2.

    [:octicons-arrow-right-24: OGC API Processes Engine](./oapip-engine.md)

-   :material-earth:{ .lg .middle } **openEO Engine**
