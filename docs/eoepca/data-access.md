...
As described in [section Resource Protection](resource-protection-gluu.md), the `resource-guard` component can be inserted into the request path of the Data Access service to provide access authorization decisions.
