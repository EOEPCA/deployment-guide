...
The file [`deploy/processing/requests/requests.http`](https://github.com/EOEPCA/deployment-guide/blob/main/deploy/processing/requests/requests.http) has been prepared with sample requests for **_OGC API Processes_** operations:
